...
| Lab | 주제 | 핵심 서비스 | 설명 |
|-----|------|------------|------|
| [Lab 01](./lab01-networking/README.md) | 네트워킹 | VNet, Subnet, Private Endpoint, Gateway, ExpressRoute | 가상 네트워크, 보안 통신, 하이브리드 연결 |
| [Lab 02](./lab02-compute-containers/README.md) | 컴퓨팅/컨테이너 | App Service, AKS, Container Apps, ACR, VM | PaaS, 컨테이너 오케스트레이션, 서버리스 |
| [Lab 03](./lab03-security-governance/README.md) | 보안/거버넌스 | Azure AD, RBAC, Policy, Compliance | 인증/인가, 정책, 규제 준수 |
| [Lab 04](./lab04-storage-cache/README.md) | 스토리지/캐시 | Storage Account, Redis Cache | Blob/File 스토리지, 인메모리 캐시 |
...
```
Azure Cloud
├── 🌐 네트워킹: VNet, Subnet, NSG, Private Endpoint, VPN/ExpressRoute, Front Door
├── 💻 컴퓨팅: VM, App Service, AKS, Container Apps, Functions
├── 🔐 보안: Azure AD, RBAC, Key Vault, Defender, Policy
